...
// Apne backend URL par point karein (local ya hosted, jaise: "http://localhost:5000/api/chat")
...
    } else {
      messageContentElement.innerHTML = "<span style='color:red;'>No valid response from AI.</span>";
